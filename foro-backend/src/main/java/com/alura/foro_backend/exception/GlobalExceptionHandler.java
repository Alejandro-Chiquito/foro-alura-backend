...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleSecurityException(Exception exception) {
        ...
        if (exception instanceof AccountStatusException) {
            ...
            errorDetail.setProperty("description", "La cuenta del usuario está deshabilitada");
        }

        if (exception instanceof AccessDeniedException) {
            errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(403), exception.getMessage());
            errorDetail.setProperty("description", "No tienes permiso para acceder a este recurso");
        }
        ...
        if (errorDetail == null) {
            ...
            errorDetail.setProperty("description", "Ha ocurrido un error inesperado");
        }
